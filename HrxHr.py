...
def gerar_hr_hr():
    if verificar_campos_preenchidos():
        ...
        #Mapeia o turno para as horas correspondentes
        horas_por_turno = {
        ...
        #Inserir os labels das colunas na primeira linha
        ...
        def funcao_de_gravacao():
            #Recuperar os dados dos campos de entrada e processe-os
            dados = []

            #Recuperar os valores do COD para cada linha separadamente
            ...
            df['Parada(em Min)'] = pd.to_numeric(df['Parada(em Min)'], errors='coerce')
            ...
            if empty_cod or empty_qtde_real:
                ...
                messagebox.showerror("Erro!",
                                     "O campo 'Parada(em Min)' não pode ser maior que o de minutos disponíveis.")
            else:
                ...
                if resposta == "yes":
                    ...
                    #Caminho do arquivo 
                    caminho = r'C:\Users\Documents\AutoWerk\Banco_de_dados\bd_hrxhr.json'
